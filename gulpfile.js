...
gulp.task('help', function () {
  var comment = `
plusminuszero 사이트를 static하게 만들어냅니다.
...
gulp.task('watch', function (callback) {
  ...
  // 이미지 수정처리
  gulp.watch(path.source.image + '/**/*.{png,jpg,gif}', ['copy:image'], callback);
});
...
//   runSequence('clean', 'copy:image', 'convert:sass', 'copy:conf', 'html', ['copy:js', 'copy:node_modules'], 'ftp');
// });
